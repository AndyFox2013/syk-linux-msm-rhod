...
/* Exported functions */
int msm_clk_regime_amss_enable(unsigned id);
void msm_clk_regime_amss_disable(unsigned id);
int msm_clk_regime_amss_is_on(unsigned id);
int msm_clk_regime_amss_set_rate(unsigned id, unsigned long rate);
int msm_clk_regime_amss_set_flags(unsigned id, unsigned long flags);
