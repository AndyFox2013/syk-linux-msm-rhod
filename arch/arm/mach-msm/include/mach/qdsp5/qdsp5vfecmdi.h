...
#define	VFE_CMD_ROLLOFF_CFG	0x0004
...
#define	VFE_CMD_RGB_GAMMA_CFG		0x0002
...
#define	VFE_CMD_Y_GAMMA_CFG		0x0003
...
/* See struct vfe_camifcfg definition in msm_vfe8x_proc.h */
...
#define	VFE_CMD_BLACK_LVL_CFG		0x000A
...
#define	VFE_CMD_ACTIVE_REGION_CFG	0x0005
...
#define	VFE_CMD_DEMOSAIC_CFG		0x0006
...
/* See struct vfe_demosaic_cfg & struct vfe_demosaic_bpc_cfg */
/* & vfe_demosaic_abf_cfg definition in msm_vfe8x_proc.h */

typedef struct {
	unsigned int	cmd_id;
	unsigned int	demosaic_part1;	/* vfe_demosaic_cfg */
	unsigned int	demosaic_part2;	/* vfe_demosaic_abf_cfg */
	unsigned int	demosaic_part3;
	unsigned int	demosaic_part4;	/* vfe_demosaic_bpc_cfg */
...
#define	VFE_CMD_IP_FORMAT_CFG		0x0007
...
#define	VFE_CMD_OP_CLAMP_CFG		0x0008
...
#define	VFE_CMD_CHROMA_SUBSAMPLE_CFG		0x0009
...
#define	VFE_CMD_STATS_WB_EXP_UPDATE	0x001F
...
#define	VFE_CMD_UPDATE_CAMIF_FRAME_CFG		0x001E
