...
struct nov_regs labc_init_seq[] = {
	...
	{0x5703, 0x28},
	{0x5704, 0x01},	//step1 Increment Value
	{0x5705, 0x08},
	{0x5706, 0x00},	//step1 Decrement Value
	{0x5707, 0xe0},
	{0x5708, 0x01},	//step2 Increment Value
	{0x5709, 0x90},
	{0x570a, 0x01},	//step2 Decrement Value
	{0x570b, 0x40},
	{0x570c, 0x02},	//step3 Increment Value
	{0x570d, 0x30},
	{0x570e, 0x02},	//step3 Decrement Value
	{0x570f, 0x08},
	{0x5710, 0x02},	//step4 Increment Value
	{0x5711, 0xfb},
	{0x5712, 0x02},	//step4 Decrement Value
	{0x5713, 0xab},
	{0x5714, 0x03},	//step5 Increment Value
	{0x5715, 0xFF},
	{0x5716, 0x03},	//step5 Decrement Value
	{0x5717, 0xFF},
};
